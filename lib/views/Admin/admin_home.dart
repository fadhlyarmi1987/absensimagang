...
class AdminPage extends StatelessWidget {
    ...
    onPressed: () {
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Obx(() {
              // Jika data kosong, tampilkan loading atau pesan kosong
              ...
              return SingleChildScrollView(
                ...
                child: DataTable(
                  columnSpacing: 20,
                  dataRowHeight: 80,
                  headingRowColor: MaterialStateProperty.all(Colors.red.shade700),
  ...
  List<DataRow> _getSortedAttendanceRows() {
    return adminController.filteredAttendanceData.entries
        .map((entry) {
          ...
          if (checkInTime != null) {
            userAttendances.sort((a, b) {
              DateTime aCheckIn = a['type'] == 'check-in' ? a['timestamp'] : DateTime(0);
              DateTime bCheckIn = b['type'] == 'check-in' ? b['timestamp'] : DateTime(0);
            ...
            cells: [
              ...
              DataCell(
                Icon(
                  ...
                  color: (isCheckedIn && isCheckedOut) ? Colors.green : const Color.fromARGB(255, 198, 198, 198),
                ),
              ),
            ],
          );
