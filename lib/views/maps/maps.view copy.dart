...
//       position: LatLng(-7.924784, 112.585625),
//       onTap: () {
...
//       center: LatLng(-7.924784, 112.585625),
//       radius: radius,
//       strokeColor: Colors.blue,
//       strokeWidth: 2,
//       fillColor: Colors.blue.withOpacity(0.1),
...
//   Future<void> cekWaktuAbsen() async {
//     DateTime now = DateTime.now();

//     bool isCheckIn = await TimeUtils.isCheckInTime(now);
//     bool isCheckOut = await TimeUtils.isCheckOutTime(now);

//     setState(() {
//       if (isCheckIn) {
//         waktuAbsen = "Waktu untuk Check-In";
//       } else if (isCheckOut) {
//         waktuAbsen = "Waktu untuk Check-Out";
//       } else {
//         waktuAbsen = "Di luar jam absensi";
//       }
//     });
//   }
...
//     final formattedStart = timeFormat.format(startTime as DateTime);
//     final formattedEnd = timeFormat.format(endTime as DateTime);
